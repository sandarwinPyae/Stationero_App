                ...
                currentRecords.map((s) => (
                  <React.Fragment key={s.sale_order_id}>
                    <tr className="cursor-pointer hover:bg-gray-50 border-b" onClick={() => setSelectedId(selectedId === s.sale_order_id ? null : s.sale_order_id)}>
                      ...
                      <td className="p-5 text-center">{(s.total_amount + s.discount).toLocaleString()}</td>
                      <td className="p-5 text-center">{s.discount.toLocaleString()}</td>
                      <td className="p-5 text-center">{s.total_amount.toLocaleString()}</td>
                      <td className="p-5">
