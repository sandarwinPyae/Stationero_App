...
const SupplierWisePurchase = ({toggleSidebar}) => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="px-4 md:px-8 pt-20 md:pt-24 pb-8">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
          <h2 className="text-xl md:text-2xl font-bold text-gray-800">Supplier-wise Purchase Report</h2>
