...
const InventoryLowStockReport = ({toggleSidebar}) => {
          ...
          <div className="flex w-full sm:w-auto justify-between items-center gap-4">
            ...
            <div className="relative">
              <button 
                ...
                className="flex items-center gap-2 px-4 py-2 bg-[#F25278] text-white font-semibold rounded-lg hover:bg-[#e0456a] transition-all"
              >
